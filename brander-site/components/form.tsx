...
const Form: React.FC<FormProps> = (props) => {
    ...
    return <>
        <div className='mb-6 text-slate-400'>
            <p>Tell me what your brand is about and I will generate a branding snippet and some keywords for you</p>
        </div>
        
        <input
        className='p-2 w-full rounded-md focus:outline-teal-600 focus:outline text-slate-800' 
        type="text" placeholder="Coffee" value={props.prompt} onChange={(e) => updatePromptValue(e.currentTarget.value)}></input>
